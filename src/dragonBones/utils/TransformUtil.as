package dragonBones.utils
{
	...
	final public class TransformUtil
	{
		...
		private static var skewXArray:Vector.<Number> = new Vector.<Number>(4);
		private static var skewYArray:Vector.<Number> = new Vector.<Number>(4);
		...
		public static function matrixToTransform(matrix:Matrix, transform:DBTransform, scaleXF:Boolean, scaleYF:Boolean):void
		{
			...
			//here is bottleneck of performance
